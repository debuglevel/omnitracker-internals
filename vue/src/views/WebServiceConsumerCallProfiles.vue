  ...
  data: function() {
    return {
      webserviceconsumercallprofiles: [
        { id: 1, name: 'WebServiceConsumer Call Profile 1', status: 'Valid', folder: { path: '\\Foo\\Bar' } },
        { id: 2, name: 'WebServiceConsumer Call Profile 2', status: 'NotSet', folder: { path: '\\Foo\\Bar' } },
      ],
    }
  },
  mounted() {
